...
var attributes =
    [
        ...
        "<div class='form-group'><label class='control-label'>内宽<span>&nbsp;(?)</span></label><select class='form-control elementSelect' name='innerWidth'><option value='0'>短</option><option value='1' selected>中</option><option value='2'>长</option></select></div>",
