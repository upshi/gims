var elements =
    [
        ...
        "<li tabindex='1' tag='1'><p>单行文本</p><input readonly type='text'></li>",
        ...
        "<li tabindex='1' tag='8' class='special'><p>座机</p><span><input type='text' placeholder='区号' readonly>&nbsp;-&nbsp;</span><span><input type='text' placeholder='号码' class='shortElement'readonly>&nbsp;-&nbsp;</span><span><input type='text' placeholder='分机号' readonly></span></li>",
        ...
        "<li tabindex='1' tag='10' class='special'><p>日期</p><span><input type='text' placeholder='年' readonly>&nbsp;-&nbsp;</span><span><input type='text' placeholder='月' readonly>&nbsp;-&nbsp;</span><span><input type='text' placeholder='日' readonly></span></li>",
        ...
        "<li tabindex='1' tag='14'><p>下拉框</p><select class='pullDown' disabled></select></li>",
